$(function() {
  // "El botón estará desactivado hasta que escribamos algo dentro del campo de entrada."
...
// "Se invocará al hacer clic en las películas recomendadas."
...
// "Obtener los detalles básicos de la película desde la API (basado en el nombre de la película)."
...
// "pasar el nombre de la película para obtener películas similares desde Flask de Python"
function movie_recs(movie_title,movie_id,my_api_key){
  $.ajax({
    ...
    success: function(recs){
      if(recs=="¡Lo siento! La película que solicitaste no está en nuestra base de datos. Por favor, verifica la ortografía o intenta con otras películas."){
        $('.fail').css('display','block');
        $('.results').css('display','none');
        $("#loader").delay(500).fadeOut();
      }
...
// "Obtener todos los detalles de la película utilizando el ID de la película."
...
// "Pasar todos los detalles a Flask de Python para mostrar y obtener críticas de películas usando el ID de IMDb."
...
// "Obtener los detalles del elenco individual."
...
// "Obteniendo los detalles del elenco para la película solicitada."
...
// "Obteniendo pósters para todas las películas recomendadas."
